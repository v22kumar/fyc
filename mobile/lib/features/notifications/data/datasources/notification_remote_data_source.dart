...
class NotificationRemoteDataSource {
  ...
  Future<NotificationModel> markAsRead(String id) async {
    final response = await dio.put('/api/v1/notifications/$id/read');
  ...
  Future<void> trackClick(String id) async {
    await dio.put('/api/v1/notifications/$id/track-click');
  }

  Future<NotificationPreferenceModel> getPreferences() async {
    final response = await dio.get('/api/v1/notifications/preferences');
