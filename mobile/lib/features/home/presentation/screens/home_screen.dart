...
const _allSearchEntries = [
  ...
  _SearchEntry('Members', 'Club member directory', '/members', Icons.groups, Color(0xFFEC4899)),
  _SearchEntry('Local Services', 'Find local tradespeople & services', '/community', Icons.handyman, Color(0xFFD97706)),
